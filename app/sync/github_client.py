...
def get_query_url(
    ...
    if repo == 'IssueTrackerSandbox':
        endpoint = \
            "https://api.github.com/repos/RHAM231-IssueTracker/IssueTrackerSandbox"
    elif repo == 'Sandbox-Import':
        endpoint = \
            "https://api.github.com/repos/RHAM231-IssueTracker/Sandbox-Import"
...
def check_for_stamp(body):
    if body:
        ...
        if nlines >= 5:
            ...
            if 'Generated by Issue Tracker: ' in line5 \
                and 'Stamp Id: ' in line6:
                check_results = True
            else:
                check_results = False
        else:
...
def serialize_github_object(
    ...
    # than parent information in children objects. Therefore, we need
